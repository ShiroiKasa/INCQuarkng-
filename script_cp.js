...
function updateUI_cp(){
    ...
    document.getElementById("cp_up1_b").innerHTML = "夸克*" + (cp_up1 + 1) + " 费用:" + formatDecimal(cp_up1_cost);
    ...
    document.getElementById("cp_up2_b").innerHTML = "原子*" + (cp_up2 + 1) + " 费用:" + formatDecimal(cp_up2_cost);
    ...
    document.getElementById("cp_up3_b").innerHTML = "引力子*" + (cp_up3 + 1) + " 费用:" + formatDecimal(cp_up3_cost);
}
